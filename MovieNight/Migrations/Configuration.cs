namespace MovieNight.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MovieNight.Models.MovieNightDB>
    {
        ...
        protected override void Seed(MovieNight.Models.MovieNightDB context)
        {
            ...
            var frank = new Director { FirstName = "Frank", LastName = "Darabont", DateOfBirth = DateTime.Parse("28/01/1959"), Gender = Gender.Male, Origin = "France", Picture = "https://images-na.ssl-images-amazon.com/images/M/MV5BNjk0MTkxNzQwOF5BMl5BanBnXkFtZTcwODM5OTMwNA@@._V1_.jpg" };
            var francis = new Director { FirstName = "Francis Ford", LastName = "Coppola", DateOfBirth = DateTime.Parse("07/04/1939"), Gender = Gender.Male, Origin = "USA", Picture = "https://images-na.ssl-images-amazon.com/images/M/MV5BMTM5NDU3OTgyNV5BMl5BanBnXkFtZTcwMzQxODA0NA@@._V1_SY1000_CR0,0,665,1000_AL_.jpg" };
            var christ = new Director { FirstName = "Christopher", LastName = "Nolan", DateOfBirth = DateTime.Parse("30/07/1970"), Gender = Gender.Male, Origin = "UK", Picture = "https://images-na.ssl-images-amazon.com/images/M/MV5BNjE3NDQyOTYyMV5BMl5BanBnXkFtZTcwODcyODU2Mw@@._V1_.jpg" };
